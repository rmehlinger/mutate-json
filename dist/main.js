...
let operations = {
  delete(original, target, path, operand) {
    deepUnset(original, target, path);
  },
  set(original, target, path, operand) {
  ...
  '++': increment,
  '--': decrement,
  push(original, target, path, operand) {
    arrayOp(original, target, 'push', operand);
  },
  pop(original, target, path, operand) {
    arrayOp(original, target, 'pop', operand);
  },
  shift(original, target, path, operand) {
    arrayOp(original, target, 'shift', operand);
  },
  unshift(original, target, path, operand) {
